...
namespace TacticalAI
{
    public class HitBox : MonoBehaviour
    {
        ...
        // last hit source
        private void HitByPlayer(bool isHitByPlayer)
        {
            lastHitByPlayer = isHitByPlayer;
            if (lastHitByPlayer)
                BattleController.instance.ActivateHitmarker();
            //Debug.Log("hit by player = " + lastHitByPlayer);
        }

        public bool GetLastHit()
        {
            //Debug.Log("get hit by player = " + lastHitByPlayer);
